...
{
    public partial class Articulo_Detalle : Form
    {
        public int intIdEmp;
        public int intIdUsu;
        ...
        public decimal decPU;
        public decimal decPonderado;
        ...
        private void OrdenCompra_Detalle_Load(object sender, EventArgs e)
        {
            ...
            else if (strAccion == "EDITAR")
            {
                ...
                txtPonderado.Text = decPonderado.ToString();
                txtPrecio.Text = decPU.ToString();
        ...
        private void btnAceptar_Click(object sender, EventArgs e)
        {
            ...
            decPU = Convert.ToDecimal(txtPrecio.Text.Trim());
            decPonderado = Convert.ToDecimal(txtPonderado.Text.Trim());
        ...
        private void txtPonderado_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                txtPrecio.Focus();
