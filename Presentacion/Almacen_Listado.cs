...
namespace Presentacion
{
    ...
    public partial class Almacen_Listado : Form
    {
        ...
        private void Almacen_Listado_Load(object sender, EventArgs e)
        {
        ...
        private void tsEliminar_Click(object sender, EventArgs e)
        {
            ...
            if (result == System.Windows.Forms.DialogResult.Yes)
            {
                ...
                if (blnTodoOK)
                {
                    MessageBox.Show("Almacen Eliminado con Éxito.!", this.Text, MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                else
                {
        ...
        public void Listar(int idEmpresa)
        {
            ...
            NGAlmacen obj = new NGAlmacen(Configuracion.Sistema.CadenaConexion);
            tbl = obj.Almacen(idEmpresa, idUsuario, ref blnTodoOK);
        ...
        private void ubicarGrilla(int yy)
        {
            ...
            src.Position = src.Find("intIdAlm", ss);
