...
{
    public partial class Placa_Listado : Form
    {
        ...
        public Placa_Listado()
        {
            InitializeComponent();
        }

        private void Placa_Listado_Load(object sender, EventArgs e)
        {
        ...
        public void Listar()
        {
            ...
            NGPlaca obj = new NGPlaca(Configuracion.Sistema.CadenaConexion);
            tbl = obj.Placa(idEmpresa, ref blnTodoOK);
        ...
        private void tsEliminar_Click(object sender, EventArgs e)
        {
            ...
            int idSeleccion;
            Clases.InicialCls.LeerXml();
            idSeleccion = Convert.ToInt32(dgvLista.CurrentRow.Cells["intIdPlaca"].Value);

            NGPlaca obj = new NGPlaca(Configuracion.Sistema.CadenaConexion);

            string message = "Estas Seguro de Eliminar esta Placa?";
            ...
            if (result == System.Windows.Forms.DialogResult.Yes)
            {
               ...
               // obj.EliminarPlaca(idSeleccion, idUsuario, ref blnTodoOK);

                if (blnTodoOK)
                {
                    MessageBox.Show("Placa Eliminada con Éxito.!", this.Text, MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                else
                {
