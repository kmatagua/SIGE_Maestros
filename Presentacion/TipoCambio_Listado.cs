...
namespace Presentacion
{
    ...
    public partial class TipoCambio_Listado : Form
    {
        ...
        public TipoCambio_Listado()
        {
            InitializeComponent();
        }

        private void TipoCambio_Listado_Load(object sender, EventArgs e)
        {
        ...
        private void tsEditar_Click(object sender, EventArgs e)
        {
            ...
            idSeleccion = Convert.ToInt32(dgvLista.CurrentRow.Cells["intIdTipoCambio"].Value);
            
            TipoCambio frm = new TipoCambio();
            frm.intIdTipoCambio = idSeleccion;
            frm.idEmpresa = idEmpresa;
            frm.nombreEmpresa = nombreEmpresa;
            frm.idUsuario = idUsuario;
            frm.tipo = 2;
        ...
        private void tsEliminar_Click(object sender, EventArgs e)
        {
            ...
            NGTipoCambio obj = new NGTipoCambio(Configuracion.Sistema.CadenaConexion);

            string message = "Estas Seguro de Eliminar este TipoCambio?";
            ...
            if (result == System.Windows.Forms.DialogResult.Yes)
            {
                ...
                if (blnTodoOK)
                {
                    MessageBox.Show("TipoCambio Eliminado con Éxito.!", this.Text, MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                else
                {
        ...
        private void tsBuscar_Click(object sender, EventArgs e)
        {
            ...
            frm.nombre_maestro = "TIPOCAMBIO";
            frm.tipoTabla = "TIPOCAMBIO";
            frm.intId = idEmpresa;
        ...
        private void tsExportar_Click(object sender, EventArgs e)
        {
            ...
            Clases.Reglas.ExportaExcel(data, "LISTA DE TIPO DE CAMBIOS REGISTRADOS");
        ...
        public void Listar()
        {
            ...
            NGTipoCambio obj = new NGTipoCambio(Configuracion.Sistema.CadenaConexion);
            tbl = obj.TipoCambio(ref blnTodoOK);
        ...
        private void ubicarGrilla(int yy)
        {
            ...
            src.Position = src.Find("intIdTipoCambio", ss);
