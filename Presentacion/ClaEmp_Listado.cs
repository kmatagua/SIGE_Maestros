...
namespace Presentacion
{
    ...
    public partial class ClaEmp_Listado : Form
    {
        ...
        public ClaEmp_Listado()
        {
            InitializeComponent();
        }

        private void ClaEmp_Listado_Load(object sender, EventArgs e)
        {
        ...
        private void tsEditar_Click(object sender, EventArgs e)
        {
            ...
            idSeleccion = Convert.ToInt32(dgvLista.CurrentRow.Cells["intIdClaEmp"].Value);

            ClaEmp frm = new ClaEmp();
            frm.intIdClaEmp = idSeleccion;
            frm.tipo = 2;
            frm.idUsuario = idUsuario;
            frm.ShowDialog();
            Listar();
        ...
        private void tsEliminar_Click(object sender, EventArgs e)
        {
            ...
            string message = "Estas Seguro de Eliminar la Clasificación de Empleado " + dgvLista.CurrentRow.Cells["strNoClaEmp"].Value + " ?";
            ...
            if (result == System.Windows.Forms.DialogResult.Yes)
            {
                ...
                if (blnTodoOK)
                {
                    MessageBox.Show("Clasificación de Empleado Eliminada con Éxito.!", this.Text, MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                else
                {
        ...
        private void tsBuscar_Click(object sender, EventArgs e)
        {
            ...
            frm.nombre_maestro = "CLASIFICACION_EMP"; //VALOR PARA ClaArt DE MEDIDA
        ...
        private void tsImprimir_Click(object sender, EventArgs e)
        {
            ...
            frmRpt.nombreRpt = "CLASIFICACION";
            frmRpt.Show();
        }
        ...
        private void tsExportar_Click(object sender, EventArgs e)
        {
            ...
            Clases.Reglas.ExportaExcel(data, "LISTA DE ClaArt REGISTRADAS");
        ...
        private void ubicarGrilla(int yy)
        {
            ...
            src.Position = src.Find("intIdClaEmp", ss);
