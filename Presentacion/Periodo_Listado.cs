...
namespace Presentacion
{
    ...
    public partial class Periodo_Listado : Form
    {
        ...
        public Periodo_Listado()
        {
            InitializeComponent();
        }

        private void Periodo_Listado_Load(object sender, EventArgs e)
        {
        ...
        private void tsEditar_Click(object sender, EventArgs e)
        {
            ...
            idSeleccion = Convert.ToInt32(dgvLista.CurrentRow.Cells["intIdPeriodo"].Value);

            Periodo frm = new Periodo();
            frm.intIdPeriodo = idSeleccion;
            frm.tipo = 2;
            frm.idUsuario = idUsuario;
        ...
        private void tsEliminar_Click(object sender, EventArgs e)
        {
            ...
            NGPeriodo obj = new NGPeriodo(Configuracion.Sistema.CadenaConexion);

            string message = "Estas Seguro de Eliminar este Periodo?";
            ...
            if (result == System.Windows.Forms.DialogResult.Yes)
            {
                ...
                {
                    MessageBox.Show("Periodo Eliminado con éxito.!", this.Text, MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                Listar();
            }
        ...
        private void tsBuscar_Click(object sender, EventArgs e)
        {
            ...
            frm.nombre_maestro = "PERIODO"; //VALOR 1 ES PARA EMPRESA
            frm.tipoTabla = "PERIODO";
        ...
        private void tsExportar_Click(object sender, EventArgs e)
        {
            ...
            Clases.Reglas.ExportaExcel(data, "LISTA DE PERIODOS REGISTRADOS");
        ...
        public void Listar()
        {
            ...
            NGPeriodo obj = new NGPeriodo(Configuracion.Sistema.CadenaConexion);
            tbl = obj.Periodo(idUsuario, ref blnTodoOK);
