...
namespace Presentacion
{
    ...
    public partial class Proveedor_Listado : Form
    {
        ...
        public Proveedor_Listado()
        {
            InitializeComponent();
        }

        private void Proveedor_Listado_Load(object sender, EventArgs e)
        {
        ...
        private void tsEditar_Click(object sender, EventArgs e)
        {
            ...
            idSeleccion = Convert.ToInt32(dgvLista.CurrentRow.Cells["intIdProv"].Value);

            Proveedor frm = new Proveedor();
            frm.idProveedor = idSeleccion;
            frm.idUsuario = idUsuario;
            frm.tipo = 2;
        ...
        private void tsEliminar_Click(object sender, EventArgs e)
        {
            ...
            NGProveedor obj = new NGProveedor(Configuracion.Sistema.CadenaConexion);

            string message = "Estas Seguro de Eliminar este Proveedor?";
            ...
            if (result == System.Windows.Forms.DialogResult.Yes)
            {
                ...
                //obj.EliminarProveedor(idSeleccion, idUsuario, ref blnTodoOK);

                if (blnTodoOK)
                {
                    MessageBox.Show("Proveedor Eliminado con Éxito.!", this.Text, MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                else
                {
        ...
        private void tsBuscar_Click(object sender, EventArgs e)
        {
            ...
            frm.nombre_maestro = "PROVEEDOR"; //VALOR PARA Proveedor
        ...
        private void tsExportar_Click(object sender, EventArgs e)
        {
            ...
            Clases.Reglas.ExportaExcel(data, "PROVEEDORES REGISTRADOS");
        ...
        public void Listar()
        {
            ...
            NGProveedor obj = new NGProveedor(Configuracion.Sistema.CadenaConexion);
            tbl = obj.Proveedor(ref blnTodoOK);
        ...
        private void ubicarGrilla(int yy)
        {
            ...
            src.Position = src.Find("intIdProv", ss);
