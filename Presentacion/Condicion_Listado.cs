...
namespace Presentacion
{
    ...
    public partial class Condicion_Listado : Form
    {
        ...
        public Condicion_Listado()
        {
            InitializeComponent();
        }

        private void Condicion_Listado_Load(object sender, EventArgs e)
        {
        ...
        private void tsEditar_Click(object sender, EventArgs e)
        {
            ...
            idSeleccion = Convert.ToInt32(dgvLista.CurrentRow.Cells["intIdCondic"].Value);

            Condicion frm = new Condicion();
            frm.intIdCondic = idSeleccion;
            frm.tipo = 2;
            frm.ShowDialog();
            Listar();
        }
        ...
        private void tsEliminar_Click(object sender, EventArgs e)
        {
            ...
            NGCondicion obj = new NGCondicion(Configuracion.Sistema.CadenaConexion);

            string message = "Estas Seguro de Eliminar esta Condicion?";
            ...
            if (result == System.Windows.Forms.DialogResult.Yes)
            {
                ...
                if (blnTodoOK)
                {
                    MessageBox.Show("Condicion Eliminada con Éxito.!", this.Text, MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                else
                {
        ...
        private void tsBuscar_Click(object sender, EventArgs e)
        {
            ...
            frm.nombre_maestro = "CONDICION"; //VALOR PARA CONDICION
        ...
        private void tsExportar_Click(object sender, EventArgs e)
        {
            ...
            Clases.Reglas.ExportaExcel(data, "LISTA DE CONDICIONES REGISTRADAS");
        ...
        public void Listar()
        {
            ...
            NGCondicion obj = new NGCondicion(Configuracion.Sistema.CadenaConexion);
            tbl = obj.Condicion(ref blnTodoOK);
        ...
        private void ubicarGrilla(int yy)
        {
            ...
            src.Position = src.Find("intIdCondic", ss);
