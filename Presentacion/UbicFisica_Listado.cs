...
namespace Presentacion
{
    ...
    public partial class UbicFisica_Listado : Form
    {
        ...
        public UbicFisica_Listado()
        {
            InitializeComponent();
        }


        private void UbicFisica_Listado_Load(object sender, EventArgs e)
        {
        ...
        private void tsEditar_Click(object sender, EventArgs e)
        {
            ...
            idSeleccion = Convert.ToInt32(dgvLista.CurrentRow.Cells["intIdUbic"].Value);

            UbicFisica frm = new UbicFisica();
            frm.intIdUbic = idSeleccion;
            frm.tipo = 2;
            frm.idUsuario = idUsuario;
            frm.ShowDialog();
            Listar();
        ...
        private void tsEliminar_Click(object sender, EventArgs e)
        {
            ...
            NGUbicFisica obj = new NGUbicFisica(Configuracion.Sistema.CadenaConexion);

            string message = "Estas Seguro de Eliminar este UbicFisica?";
            ...
            if (result == System.Windows.Forms.DialogResult.Yes)
            {
                ...
                if (blnTodoOK)
                {
                    MessageBox.Show("UbicFisica Eliminado con Éxito.!", this.Text, MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                else
                {
        ...
        private void tsBuscar_Click(object sender, EventArgs e)
        {
            ...
            frm.nombre_maestro = "UBICACION"; //VALOR PARA UBICACION FISICA
        ...
        private void tsExportar_Click(object sender, EventArgs e)
        {
            ...
            Clases.Reglas.ExportaExcel(data, "LISTA DE UBICACION FISICA REGISTRADAS");
        ...
        public void Listar()
        {
            ...
            NGUbicFisica obj = new NGUbicFisica(Configuracion.Sistema.CadenaConexion);
            tbl = obj.UbicFisica(idEmpresa, ref blnTodoOK);
        ...
        private void ubicarGrilla(int yy)
        {
            ...
            src.Position = src.Find("intIdUbic", ss);
