...
namespace Presentacion
{
    ...
    public partial class Marca_Listado : Form
    {
        ...
        public Marca_Listado()
        {
            InitializeComponent();
        }


        private void Marca_Listado_Load(object sender, EventArgs e)
        {
        ...
        private void tsEditar_Click(object sender, EventArgs e)
        {
            ...
            idSeleccion = Convert.ToInt32(dgvLista.CurrentRow.Cells["intIdMarca"].Value);

            Marca frm = new Marca();
            frm.intIdMarca = idSeleccion;
            frm.tipo = 2;
            frm.ShowDialog();
            Listar();
        }
        ...
        private void tsEliminar_Click(object sender, EventArgs e)
        {
            ...
            string message = "Estas Seguro de Eliminar este Marca?";
            ...
            if (result == System.Windows.Forms.DialogResult.Yes)
            {
                ...
                if (blnTodoOK)
                {
                    MessageBox.Show("Marca Eliminado con Éxito.!", this.Text, MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                else
                {
        ...
        private void tsBuscar_Click(object sender, EventArgs e)
        {
            ...
            frm.nombre_maestro = "MARCA"; //VALOR PARA MARCA
        ...
        private void ubicarGrilla(int yy)
        {
            ...
            src.Position = src.Find("intIdMarca", ss);
