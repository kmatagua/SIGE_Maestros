...
namespace Presentacion
{
    ...
    public partial class Usuario_Listado : Form
    {
        ...
        public Usuario_Listado()
        {
            InitializeComponent();
        }

        private void Usuario_Listado_Load(object sender, EventArgs e)
        {
        ...
        private void tsEditar_Click(object sender, EventArgs e)
        {
            ...
            idSeleccion = Convert.ToInt32(dgvLista.CurrentRow.Cells["id"].Value);

            Usuario frm = new Usuario();
            frm.idUsuario = idUsuario;
            frm.idSeleccion = idSeleccion;
            frm.tipo = 2;
            frm.ShowDialog();
            Listar();
        }
        ...
        private void tsEliminar_Click(object sender, EventArgs e)
        {
            ...
            string message = "Estas Seguro de Eliminar este Usuario con el ID = '"+ idSeleccion +"' ?";
            string caption = "Corfirmar Eliminación";
            ...
            if (result == System.Windows.Forms.DialogResult.Yes)
            {
                ...
                if (blnTodoOK)
                {
                    MessageBox.Show("Usuario Eliminado con Éxito.!", this.Text, MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                else
                {
        ...
        private void tsBuscar_Click(object sender, EventArgs e)
        {
            ...
            frm.nombre_maestro = "USUARIO"; //VALOR PARA USUARIO
            frm.tipoTabla = "USUARIO";
        ...
        private void tsExportar_Click(object sender, EventArgs e)
        {
            ...
            Clases.Reglas.ExportaExcel(data, "LISTA DE USUARIOS REGISTRADOS");
        ...
        public void Listar()
        {
            ...
            NGUsuario obj = new NGUsuario(Configuracion.Sistema.CadenaConexion);
            tbl = obj.Usuario(idUsuario, ref blnTodoOK);
        ...
        private void ubicarGrilla(int yy)
        {
            ...
            src.Position = src.Find("intIdUsu", ss);
