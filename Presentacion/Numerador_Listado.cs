...
namespace Presentacion
{
    ...
    public partial class Numerador_Listado : Form
    {
        ...
        public Numerador_Listado()
        {
            InitializeComponent();
        }

        private void Numerador_Listado_Load(object sender, EventArgs e)
        {
        ...
        private void tsEditar_Click(object sender, EventArgs e)
        {
            ...
            idSeleccion = Convert.ToInt32(dgvLista.CurrentRow.Cells["intIdNum"].Value);
             
            Numerador frm = new Numerador();
            frm.intIdNumerador = idSeleccion;
            frm.idEmpresa = idEmpresa;
            //frm.nombreEmpresa = nombreEmpresa;
            frm.idUsuario = idUsuario;
            frm.tipo = 2;
        ...
        private void tsBuscar_Click(object sender, EventArgs e)
        {
            ...
            frm.nombre_maestro = "NUMERADOR";
            frm.tipoTabla = "NUMERADOR";
            frm.intId = idEmpresa;
        ...
        private void ubicarGrilla(int yy)
        {
            ...
            src.Position = src.Find("intIdNum", ss);
