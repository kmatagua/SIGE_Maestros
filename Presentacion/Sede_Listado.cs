...
namespace Presentacion
{
    ...
    public partial class Sede_Listado : Form
    {
        ...
        private void Sede_Listado_Load(object sender, EventArgs e)
        {
        ...
        private void tsExportar_Click(object sender, EventArgs e)
        {
            ...
            Clases.Reglas.ExportaExcel(data, "LISTA DE SEDES REGISTRADAS");
        ...
        private void ubicarGrilla(int yy)
        {
            ...
            src.Position = src.Find("intIdSede", ss);
