...
namespace Presentacion
{
    ...
    public partial class ClientesAprobar_Listado : Form
    {
        ...
        public ClientesAprobar_Listado()
        {
            InitializeComponent();
        }

        private void ClientesAprobar_Listado_Load(object sender, EventArgs e)
        {
        ...
        public void Listar()
        {
            ...
            NGCliente obj = new NGCliente(Configuracion.Sistema.CadenaConexion);
            tbl = obj.ClienteAprobar(ref blnTodoOK);
            src.DataSource = tbl;
            dgvLista.DataSource = src;
