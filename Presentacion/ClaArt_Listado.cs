...
namespace Presentacion
{
    ...
    public partial class ClaArt_Listado : Form
    {
        ...
        public ClaArt_Listado()
        {
            InitializeComponent();
        }

        private void ClaArt_Listado_Load(object sender, EventArgs e)
        {
        ...
        private void tsEditar_Click(object sender, EventArgs e)
        {
            ...
            idSeleccion = Convert.ToInt32(dgvLista.CurrentRow.Cells["intIdClaArt"].Value);

            ClaArt frm = new ClaArt();
            frm.intIdClaArt = idSeleccion;
            frm.tipo = 2;
            frm.idUsuario = idUsuario;
            frm.ShowDialog();
            Listar();
        ...
        private void tsEliminar_Click(object sender, EventArgs e)
        {
            ...
            string message = "Estas Seguro de Eliminar esta ClaArt?";
            ...
            if (result == System.Windows.Forms.DialogResult.Yes)
            {
                ...
                if (blnTodoOK)
                {
                    MessageBox.Show("ClaArt Eliminada con Éxito.!", this.Text, MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                else
                {
        ...
        private void tsBuscar_Click(object sender, EventArgs e)
        {
            ...
            frm.nombre_maestro = "CLASIFICACION_ART"; //VALOR PARA CLAART
        ...
        private void ubicarGrilla(int yy)
        {
            ...
            src.Position = src.Find("intIdClaArt", ss);
