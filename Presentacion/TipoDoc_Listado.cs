...
namespace Presentacion
{
    ...
    public partial class TipoDoc_Listado : Form
    {
        ...
        public TipoDoc_Listado()
        {
            InitializeComponent();
        }

        private void TipoDoc_Listado_Load(object sender, EventArgs e)
        {
        ...
        private void tsEditar_Click(object sender, EventArgs e)
        {
            ...
            idSeleccion = Convert.ToInt32(dgvLista.CurrentRow.Cells["intIdTipDoc"].Value);

            TipoDoc frm = new TipoDoc();
            frm.intIdTipDoc = idSeleccion;
            frm.tipo = 2;
            frm.idUsuario = idUsuario;
            frm.ShowDialog();
            Listar();
        ...
        private void tsEliminar_Click(object sender, EventArgs e)
        {
            ...
            string message = "Estas Seguro de Eliminar este Tipo de Documento?";
            ...
            if (result == System.Windows.Forms.DialogResult.Yes)
            {
                ...
                if (blnTodoOK)
                {
                    MessageBox.Show("Tipo de Documento Eliminado con Éxito.!", this.Text, MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                else
                {
        ...
        private void tsBuscar_Click(object sender, EventArgs e)
        {
            ...
            frm.nombre_maestro = "TIPODOC"; //VALOR PARA TIPO DE DOCUMENTO
            frm.intId = idEmpresa;
        ...
        private void tsExportar_Click(object sender, EventArgs e)
        {
            ...
            Clases.Reglas.ExportaExcel(data, "LISTA DE UNIDADES REGISTRADAS");
        ...
        private void ubicarGrilla(int yy)
        {
            ...
            src.Position = src.Find("intIdTipDoc", ss);
