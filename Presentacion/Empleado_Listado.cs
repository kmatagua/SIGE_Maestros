...
namespace Presentacion
{
    ...
    public partial class Empleado_Listado : Form
    {
        ...
        public Empleado_Listado()
        {
            InitializeComponent();
        }

        private void Empleado_Listado_Load(object sender, EventArgs e)
        {
        ...
        private void tsExportar_Click(object sender, EventArgs e)
        {
            ...
            Clases.Reglas.ExportaExcel(data, "LISTA DE EMPLEADOS REGISTRADOS");
        ...
        public void Listar()
        {
            ...
            NGEmpleado obj = new NGEmpleado(Configuracion.Sistema.CadenaConexion);
            tbl = obj.Empleado(idEmpresa ,ref blnTodoOK);
