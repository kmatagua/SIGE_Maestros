...
namespace Presentacion
{
    ...
    public partial class Motivo_Listado : Form
    {
        ...
        public Motivo_Listado()
        {
            InitializeComponent();
        }

        private void Motivo_Listado_Load(object sender, EventArgs e)
        {
        ...
        private void tsEditar_Click(object sender, EventArgs e)
        {
            ...
            idSeleccion = Convert.ToInt32(dgvLista.CurrentRow.Cells["intIdMot"].Value);

            Motivo frm = new Motivo();
            frm.intIdMotivo = idSeleccion;
            frm.tipo = 2;
            frm.ShowDialog();
            Listar();
        }
        ...
        private void tsBuscar_Click(object sender, EventArgs e)
        {
            ...
            frm.nombre_maestro = "MOTIVO"; //VALOR PARA MOTIVO
        ...
        private void tsExportar_Click(object sender, EventArgs e)
        {
            ...
            Clases.Reglas.ExportaExcel(data, "LISTA DE MOTIVOS REGISTRADAS");
        ...
        private void ubicarGrilla(int yy)
        {
            ...
            src.Position = src.Find("intIdMot", ss);
