...
namespace Datos
{
    public class DAPlaca
    {
        private string _pStrConString = string.Empty;

        public DAPlaca(string p_pStrConString)
        {
            _pStrConString = p_pStrConString;
        }

        public DataTable ListaPlaca(int idEmpresa, ref bool pBlnTodoOk)
        {
            ...
            {
                cn.Open();
                SqlDataAdapter da = new SqlDataAdapter("SP_PLACA_Q01", cn);
        ...
        public DataTable BuscarPlaca(int intIdPlaca, ref bool pBlnTodoOk)
        {
            SqlConnection cn = new SqlConnection(_pStrConString);
            pBlnTodoOk = false;
            ...
            {
                cn.Open();
                SqlDataAdapter da = new SqlDataAdapter("SP_PLACA_Q02", cn);
                da.SelectCommand.CommandType = CommandType.StoredProcedure;
                da.SelectCommand.Parameters.AddWithValue("@intIdPlaca", intIdPlaca);
                da.Fill(rowTbl);
                pBlnTodoOk = true;
                cn.Close();
            }
        ...
        public void InsertarPlaca(ENPlaca obj, ref string mensaje, ref bool pBlnTodoOk)
        {
            SqlConnection cn = new SqlConnection(_pStrConString);
            pBlnTodoOk = false;
            ...
            {
                cn.Open();
                SqlDataAdapter da = new SqlDataAdapter("SP_PLACA_I01", cn);
                da.SelectCommand.CommandType = CommandType.StoredProcedure;
                da.SelectCommand.Parameters.AddWithValue("@strNoPlaca", obj.strNoPlaca);
                da.SelectCommand.Parameters.AddWithValue("@strDescripcion", obj.strDescripcion);
                da.SelectCommand.Parameters.AddWithValue("@intIdTransInter", obj.intIdTransInter);
        ...
        public void EditarPlaca(ENPlaca obj, ref bool pBlnTodoOk)
        {
            SqlConnection cn = new SqlConnection(_pStrConString);
            pBlnTodoOk = false;
            ...
            {
                cn.Open();
                SqlDataAdapter da = new SqlDataAdapter("SP_PLACA_U01", cn);
                da.SelectCommand.CommandType = CommandType.StoredProcedure;
                da.SelectCommand.Parameters.AddWithValue("@intIdPlaca", obj.intIdPlaca);
                da.SelectCommand.Parameters.AddWithValue("@strNoPlaca", obj.strNoPlaca);
                da.SelectCommand.Parameters.AddWithValue("@strDescripcion", obj.strDescripcion);
                da.SelectCommand.Parameters.AddWithValue("@intIdTransInter", obj.intIdTransInter);
                da.SelectCommand.Parameters.AddWithValue("@intEstado", obj.intEstado);
